    ...
    */
    ...
    'grant_types' => [
        'password' => [
            ...
            'callback' => '\App\OAuth\PasswordVerifier@verify',
            'access_token_ttl' => env('OAUTH2_TOKEN_TTL', 36000),
        ],
        'refresh_token' => [
        ...
        'social' => [
            'class' => '\App\OAuth\SocialGrant',
            'callback' => '\App\OAuth\SocialGrant@verify',
            'access_token_ttl' => env('OAUTH2_TOKEN_TTL', 36000)
           /* 'callback' => function ($socialType) {
                switch ($socialType) {
                    case 'facebook':
